...
getHeaders() {
 ...
 submitForm() {
  ...
  if ( this.form.get('files').value !== ' ' ) {
    ...
    this.http.post('http://api.princesolutions.co.za/api/file/books' , formData, this.getHeaders()  ).subscribe(
        // check errors
      (response: any) => {
        this.toastService.presentToast('book Uploaded successfully.');
  ...
  getBooks() {
    ...
    this.http.get('http://api.princesolutions.co.za/api/file/books', this.getHeaders()   ).subscribe((apart: any) => {
        this.imgProps = apart;
  ...
  async AlertDeleteBooks(i) {
    const alert = await this.alertController.create({
      header: 'Are you sure You want to Delete this Book?',
  ...
  downloadBooks(i) {
    ...
    (res: any) => {
      this.toastService.presentToast('book downloaded successfully.');
      this.hideProgressBar();
  ...
  async AlertDownloadBooks(i) {
    const alert = await this.alertController.create({
      header: 'Are you sure You want to Download this book?',

...
getHeaders() {
 ...
 submitForm() {
  ...
  async AlertDownloadDocuments(i) {
    const alert = await this.alertController.create({
      header: 'Are you sure You want to Download this Document?',
